  ...
  <div class="list-layout" :key="collection">
    <div class="left-panel">
      <v-progress-linear v-if="loading"
        indeterminate class="progress-bar"></v-progress-linear>
      ...
      <v-list class="list">
        <v-list-item class="item"
          ...
          :class="{ 'selected': selected && selected._id === item._id }">
          <v-list-item-avatar>
            <v-img :src="item.icon ?
    ...
    <div class="right-panel">
      ...
      <ig-object-viewer v-if="selected" :value="selected" :root="selected"
        :schema="schema"
        class="json-viewer"></ig-object-viewer>
    </div>
  </div>
</template>
        ...
        if (this.backOnSelect) {
          ...
          this.$router.push({
            ...
            query: {
              ...
              back: this.$router.currentRoute.path
            }
          })
        }
      }
